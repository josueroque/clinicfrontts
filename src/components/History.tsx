import React, { Fragment, useState,useContext,useEffect, ReactType } from 'react';
import { makeStyles } from '@material-ui/core/styles';
import { Container,Grid,Button,FormControl,TextField,FormLabel,
...
function TabPanel(props: TabPanelProps) {
  ...
  const [familyHypertension,updateFamilyHypertension]=useState<boolean>(false);
  const [familyPreeclampsia,updateFamilyPreeclampsia]=useState<boolean>(false);
  ...
  const [personalHypertension,updatePersonalHypertension]=useState<boolean>(false);
  const [personalPreeclampsia,updatePersonalPreeclampsia]=useState<boolean>(false);
  const [personalEeclampssia,updatePersonalEeclampsia]=useState<boolean>(false);
  ...
  return (
    ...
    <h1  className="HistoryTitle"> 
      ...
      <div className="CenteredDiv">
        <FormControl >   
        { savedStatus===true?
          <Alert severity={errorStatus===true?'error':'success'}>{errorStatus===true ? 'An error occured, please check your data':'History Information has been saved succefully!'}</Alert>
        :''  
        }
        </FormControl>
      </div>      
              ...
              <Container className="Obstetrics">
                      <FormControl className="Form-Obstetrics"> 
                          <TextField 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>)=>{updatePreviousGestation(parseInt(e.target.value))}}
                          />
                    </FormControl> 
                    ...
                    <FormControl className="Form-Obstetrics"> 
                          <TextField 
                            ...
                            size="small"
                            value={cesareans}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>{updateCesareans(parseInt(e.target.value))}}
                          />
                    </FormControl> 
        ...
        <Container className="Container-History">
          <FormGroup className="Form">
              ...
              <FormControl > 
                  ...
                  <Select  name="contraceptiveMethod" value={contraceptiveMethod}  onChange={(e: any)=>{updateContraceptiveMethod(e.target.value)}}  > 
