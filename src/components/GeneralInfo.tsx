...
const GeneralInfo = (props: any) => {
  ...
  useEffect(() => {
    if (patient) {
      ...
      patient.socialInsurance === "true"
        ? updateSocialInsurance("true")
        : updateSocialInsurance("false");
        ...
        {savedStatus === true ? (
          <Alert severity={errorStatus === true ? "error" : "success"}>
            {errorStatus === true
              ...
              : "Patient Information has been saved succefully!"}
          </Alert>
        ) : (
          ""
        )}
        ...
        >
          <FormGroup className='Form-General'>
            <Container>
              ...
              <FormControl>
                <FormLabel
                  className='RadioLabel FormTextGeneral'
                  component='legend'
                >
                  Social Security?
                </FormLabel>
              ...
              <FormControl className='ListInfo'>
                <InputLabel id='demo-simple-select-label' className='ListLabel'>
                  Municipality
                </InputLabel>
                <Select
                  name='city'
                  ...
                  className='FormTextGeneral'
                >
                  <MenuItem className='column' key='default' value='default'>
                    ---Select municipality---
                  </MenuItem>
                  <MenuItem key='San Pedro Sula' value='San Pedro Sula'>
                    San Pedro Sula
                  </MenuItem>
                  <MenuItem key='Tegucigalpa' value='Tegucigalpa'>
                    Tegucigalpa
                  </MenuItem>
                  <MenuItem key='Danli' value='Danli'>
                    Danli
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            <Container>
              ...
              <FormControl className='ListInfo'>
                ...
                >
                  ...
                  <MenuItem key='Married' value='none'>
                    Married
                  </MenuItem>
                  <MenuItem key='Single' value='basic'>
                    Single
                  </MenuItem>
                  <MenuItem key='Common Law' value='Other'>
                    Common Law
                  </MenuItem>
              ...
              <FormControl className='ListInfo'>
                ...
                <Select
                  ...
                  onChange={(e: any) => {
                    updateEducationLevel(e.target.value);
                  }}
                >
                  <MenuItem className='column' key='default' value='default'>
                    ---Select level---
                  ...
                  <MenuItem key='Bachelor degree' value='Bachelor degree'>
                    Bachelor degree
                  </MenuItem>
                </Select>
              </FormControl>
              <FormControl>
                <TextField
                  ...
                  value={controlPlace}
                  onChange={(e) => {
                    updateControlPlace(e.target.value);
                  }}
                />
              </FormControl>
              <FormControl>
                <TextField
                  ...
                  onChange={(e) => {
                    updateChildBirthPlace(e.target.value);
                  }}
                />
              </FormControl>
              <FormControl>
          ...
          <Grid container justify='center'>
            <ButtonGroup>
              ...
              {patient !== null ? (
                <Link
                  to={{ pathname: `/history/` + patient._id }}
                  className='Link HistoryButton'
                >
                  <Button
                    className='centerButton HistoryButton'
                    type='submit'
                    variant='contained'
                    color='primary'
                  >
